...
<div class="Inside_pages clearfix">
  ...
  <!--左侧菜单栏样式-->
   <div class="user_left">
      <div class="user_info">
       <div class="Head_portrait"><img src="/static/web/images/product_img_17.png"  width="80px" height="80px"/><!--头像区域--></div>
    ...
    <div class="Collect">
      <ul class="Collect_list">
       ...
       <div class="Collect_pro_name">
        ...
        <p class="img center"><a href="#"><img src="/static/web/images/product_img_17.png" /></a></p>
