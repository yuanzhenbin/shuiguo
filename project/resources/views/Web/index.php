                ...
                <ul class="heros clearfix">
                    <li class="hero">
                        <a href="#" target="_blank" title="第一张图的说明">
                            <img src="/static/web/images/pic1.jpg" class="thumb" alt="" />
                        </a>
                    ...
                    <li class="hero">
                        <a href="#" target="_blank" title="第二张图的说明">
                            <img src="/static/web/images/pic2.jpg" class="thumb" alt="" />
                        </a>
                        <div class="p_title_name">
                          <div class="p_recommend_info">
                           <h3>南岭荔枝水嫩香甜礼盒装</h3>
                    ...
                    <li class="hero">
                        <a href="#" target="_blank" title="第三张图的说明">
                            <img src="/static/web/images/pic3.jpg" class="thumb" alt="" />
                        </a>
                        <div class="p_title_name">
                          <div class="p_recommend_info">
                           <h3>南岭荔枝水嫩香甜礼盒装</h3>
                    ...
                    <li class="hero">
                        <a href="#" target="_blank" title="第4张图的说明">
                            <img src="/static/web/images/pic4.jpg" class="thumb" alt="" />
                        </a>
                        <div class="p_title_name">
                          <div class="p_recommend_info">
                           <h3>南岭荔枝水嫩香甜礼盒装</h3>
