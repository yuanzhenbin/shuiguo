...
<div class="header_Section">
 <div class="shortcut">
  <ul>
   ...
   <li  class="hd_menu_tit"><em class="cart_img"></em><a href="/shopping_cart">购物车（0）</a></li>
 ...
 <div class="nav" id="Navigation">
  <ul class="Navigation_name"> 
   ...
   <li class=""><a href="#">所有果蔬</a></li>
   <li class=""><a href="#">活动专区</a></li>
   <li class=""><a href="#">水果馆</a></li>
   <li class=""><a href="#">素菜馆</a></li>
 ...
 <div class="register">
     <div class="register_style">
      <div class="u_register">
        <ul>
         <li><label class="name">手机号码：</label><input name="" type="text"  class="text_Add"/></li>
         <li><label class="name">用户名称：</label><input name="" type="text"  class="text_Add"/></li>
         <li><label class="name">设置密码：</label><input name="" type="password"  class="text_Add" placeholder="6-20个字符，由字母、数字和符号的两种以上组合"/></li>
         <li><label class="name">确认密码：</label><input name="" type="password"  class="text_Add"/></li>
         <li><label class="name">验&nbsp;证&nbsp;&nbsp;码：</label><input name="" type="text"  class="text_verification"/></li>
        </ul>
         ...
         <div class="register-btn"><a href="javascript:;" class="btn_register">注&nbsp;&nbsp;&nbsp;&nbsp;册</a></div>
      </div>
     </div>
